...
class Teacher extends Component {
    ...
    componentDidMount() {
        ...
        this.props.Stores.handleGetTeacher();
    }
    ...
    handleReset = () => {
        ...
        this.props.Stores.teacherTotal = 0;
        this.props.Stores.teacherCurrent = 1;
        ...
        return (
            <div>
                ...
                <Table
                    bordered={true}
                    pagination={{
                        current: store.teacherCurrent,
                        pageSize: store.pageSize,
                        total: store.teacherTotal,
                    }}
                    columns={columns}
                    style={{ marginTop: "10px", textAlign: 'center' }}
                    dataSource={Stores.teacherData}
                // onChange={({ current }) => {
